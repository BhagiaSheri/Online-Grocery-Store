...
$product_brand_id = mysqli_real_escape_string($con, $_POST['brand']);
$brandid = explode("-", $product_brand_id);
$brandid = $brandid[0];
$product_category_id = mysqli_real_escape_string($con, $_POST['category']);
$catid = explode("-", $product_category_id);
$catid = $catid[0];
$product_search_keywords = mysqli_real_escape_string($con, $_POST['product_search_keywords']);
$product_price = mysqli_real_escape_string($con, $_POST['price']);
$product_quantity = mysqli_real_escape_string($con, $_POST['quantity']);
$product_image = mysqli_real_escape_string($con, basename($_FILES["fileToUpload"]["name"]));
$target_dir = "images/";
